            ...
            <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="450px" height="460px" viewBox="0 0 450 460" enableBackground="new 0 0 450 460" xmlSpace="preserve" className="mx-auto">
                <style>
                    {`
                        ...
                        #svg-map text { fill: #000000; font: 12px Arial-BoldMT, sans-serif; cursor: pointer; }
                        #svg-map a { text-decoration: none; }
                        #svg-map a:hover { cursor: pointer; text-decoration: none; }
                        #svg-map a:hover path { fill: #feffff !important; }
                        #svg-map .circle { fill: #66ccff; }
                        #svg-map a:hover .circle { fill: #003399 !important; cursor: pointer; }
                        #state-mt, #state-ms, #state-to, #state-sp { fill: #F5B800 !important; }
                        #svg-map a:hover #state-mt,
                        #svg-map a:hover #state-ms,
                        #svg-map a:hover #state-to,
                        #svg-map a:hover #state-sp { fill: #D4A000 !important; }
                    `}
                </style>
                <g>
                {/* TO - Tocantins (clicável) */}
                <g onClick={() => onStateClick('TO')} style={{ cursor: 'pointer' }}>
                    <path id="state-to" stroke="#FFFFFF" strokeWidth="1.0404" strokeLinecap="round" strokeLinejoin="round" d="M289.558,235.641
                ...
                <path stroke="#FFFFFF" strokeWidth="1.0404" strokeLinecap="round" strokeLinejoin="round" d="M3.656,148.545
                    ...
                    c6.299-3.41-3.107-11.9-5.216-15.679c-0.52-0.918-3.588-4.655-3.629-5.957C1.642,150.174,6.612,151.968,3.656,148.545z"></path>                {/* RO - Rondônia */}
                ...
                {/* MT - Mato Grosso (clicável) */}
                <g onClick={() => onStateClick('MT')} style={{ cursor: 'pointer' }}>
                    <path id="state-mt" stroke="#FFFFFF" strokeWidth="1.0404" strokeLinecap="round" strokeLinejoin="round" d="M142.237,173.962
                ...
                {/* MS - Mato Grosso do Sul (clicável) */}
                <g onClick={() => onStateClick('MS')} style={{ cursor: 'pointer' }}>
                    <path id="state-ms" stroke="#FFFFFF" strokeWidth="1.0404" strokeLinecap="round" strokeLinejoin="round" d="M183.198,294.536
                ...
                {/* SP - São Paulo (clicável) */}
                <g onClick={() => onStateClick('SP')} style={{ cursor: 'pointer' }}>
                    <path id="state-sp" stroke="#FFFFFF" strokeWidth="1.0404" strokeLinecap="round" strokeLinejoin="round" d="M239.3,330.554
                ...
                <div className="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto pr-2" style={{ scrollbarWidth: 'thin', scrollbarColor: '#F5B800 #f3f4f6' }}>
                    {allCities.map(city => (
                        <div key={city.name} className="flex items-center justify-between bg-gradient-to-r from-gray-50 to-white p-2.5 rounded-lg border border-gray-100 hover:border-yabuta-yellow/30 transition-colors">
                            ...
                            <span className="text-xs font-bold bg-yabuta-yellow text-yabuta-dark px-2.5 py-1 rounded-full shadow-sm">{city.state}</span>
                        </div>
                    ))}
                </div>
            </div>

            <div className="mt-6 bg-gradient-to-br from-gray-50 to-white p-4 rounded-xl border border-gray-100 flex items-center justify-center">
                <img src={logoYabutaPositivo} alt="Yabuta" className="h-16 opacity-90 hover:opacity-100 transition-opacity" />
            </div>
        </div>
    </div>
));
