        ...
        <div className="grid md:grid-cols-2 gap-8 items-start max-w-6xl mx-auto">
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">Hoje a empresa possui modernas unidades de produção nos municípios de Bastos-SP, Rancharia-SP, Queiroz-SP, Rinópolis-SP, Poxoréu-MT, Sinop-MT, Jutiema-MS, Jateí-MS e Angico-TO. Todas elas independentes, cada uma possui a própria Fábrica de Ração e Central de Processamento de Ovos.</p>
            </div>
             <div>
              <h3 className="text-xl font-bold mb-1.5 text-yabuta-dark flex items-center">
                <EggIcon className="mr-3" />
          ...
          <div className="space-y-4">
            ...
            <InfoCard title="Visão">
              Ser a principal empresa produtora de ovos de qualidade do Brasil, reconhecida pela excelência em seus processos.
            </InfoCard>
            <InfoCard title="Missão">
              Gerar empregos, renda e ter o compromisso de fornecer alimentos de qualidade e custos acessíveis.
            </InfoCard>
